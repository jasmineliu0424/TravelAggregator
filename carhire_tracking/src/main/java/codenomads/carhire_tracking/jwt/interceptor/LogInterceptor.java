package codenomads.carhire_tracking.jwt.interceptor;
...
import codenomads.carhire_tracking.exceptions.CustomException;
import codenomads.carhire_tracking.jwt.JwtUtils;
import codenomads.carhire_tracking.jwt.annotation.SkipToken;
...
public class LogInterceptor {
    ...
    @Around("execution(* codenomads.carhire_tracking.controller.*.*(..))")
