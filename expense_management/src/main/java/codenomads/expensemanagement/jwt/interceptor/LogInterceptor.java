package codenomads.expensemanagement.jwt.interceptor;
...
import codenomads.expensemanagement.exceptions.CustomException;
import codenomads.expensemanagement.jwt.JwtUtils;
import codenomads.expensemanagement.jwt.annotation.SkipToken;
...
public class LogInterceptor {
    ...
    @Around("execution(* codenomads.expensemanagement.controller.*.*(..))")
