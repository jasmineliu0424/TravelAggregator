package codenomads.experience_tracking.jwt.interceptor;
...
import codenomads.experience_tracking.jwt.JwtUtils;
import codenomads.experience_tracking.jwt.annotation.SkipToken;
...
public class LogInterceptor {
    ...
    @Around("execution(* codenomads.experience_tracking.controller.*.*(..))")
