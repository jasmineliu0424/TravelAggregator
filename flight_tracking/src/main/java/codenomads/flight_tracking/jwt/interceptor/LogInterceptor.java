package codenomads.flight_tracking.jwt.interceptor;
...
import codenomads.flight_tracking.exceptions.CustomException;
import codenomads.flight_tracking.jwt.JwtUtils;
import codenomads.flight_tracking.jwt.annotation.SkipToken;
...
public class LogInterceptor {
    ...
    @Around("execution(* codenomads.flight_tracking.controller.*.*(..))")
