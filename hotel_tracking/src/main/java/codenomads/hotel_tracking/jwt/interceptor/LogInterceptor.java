package codenomads.hotel_tracking.jwt.interceptor;
...
import codenomads.hotel_tracking.exceptions.CustomException;
import codenomads.hotel_tracking.jwt.JwtUtils;
import codenomads.hotel_tracking.jwt.annotation.SkipToken;
...
public class LogInterceptor {
    ...
    @Around("execution(* codenomads.hotel_tracking.controller.*.*(..))")
